...
const CLUB_COLORS = { neon:'#00aaff', elvis:'#8B6348', enot:'#e03535' };
...
export default function GarconPage() {
  ...
  return (
    <div className="page">
      {/* Topbar */}
      <div className="topbar" style={{ borderBottom: `3px solid ${clubColor}`, background: `linear-gradient(135deg, var(--bg) 0%, ${clubColor}18 100%)` }}>
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          <span className="logo" style={{ color: clubColor }}>NEON</span>
          <span style={{ background: clubColor, color: '#000', padding:'3px 12px', borderRadius:20, fontSize:13, fontWeight:800, letterSpacing:1 }}>
